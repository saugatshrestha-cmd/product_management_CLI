...
// User routes
router.get('/view', AuthMiddleware.verifyToken, RoleMiddleware.hasRole('customer'), controller.getProfile.bind(controller));
router.put('/update', AuthMiddleware.verifyToken, new Validator(updateUserSchema).validate(), RoleMiddleware.hasRole('customer'), controller.updateProfile.bind(controller));
